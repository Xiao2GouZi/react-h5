...
function dpsInit() {
    return __awaiter(this, void 0, void 0, function () {
        var dpsConfFile, url, value;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dpsConfFile = resolveDir(DefConf.filename);
                ...
                case 2:
                    value = (_a.sent()).value;
                    if (value) {
                        fsExtra.writeFile(resolveDir(DefConf.filename), DefConf.config(url), function (err) {
                            if (err)
                                throw err;
