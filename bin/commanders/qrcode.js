...
var qrcode = function () { return __awaiter(void 0, void 0, void 0, function () {
    var promptList, res, route, promptInput, _res, qrUrl;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                res = _a.sent();
                route = '';
                if (!(res.description === 'custom')) return [3 /*break*/, 3];
                promptInput = [{
                        type: 'input',
                        name: 'description',
